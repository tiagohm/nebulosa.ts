...
- **Streak rejection** — optional source-pixel masks in batch/live stacking, with reusable detection, classification filters, contamination diagnostics, and mask-aware interpolation, normalization, and Drizzle weights.
