...
export { EARTH_ROTATION, JUPITER_ROTATION, JUPITER_SYSTEM_I, JUPITER_SYSTEM_II, MARS_ROTATION, MERCURY_ROTATION, MOON_ROTATION, NEPTUNE_ROTATION, SATURN_ROTATION, SUN_ROTATION, URANUS_ROTATION, VENUS_ROTATION } from './orientation.data'
