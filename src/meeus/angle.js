// angle.js, Chapter 17: Angular Separation.
/**
 ...
 * small separations, remains unstable for separations near pi.
 *
...
export function relativePosition (c1, c2) {
  const [sinDeltar, cosDeltar] = base.sincos(c1.ra - c2.ra)
  const [sind2, cosd2] = base.sincos(c2.dec)
  const p = atan2(sinDeltar, cosd2 * tan(c1.dec) - sind2 * cosDeltar)
  return p
}
