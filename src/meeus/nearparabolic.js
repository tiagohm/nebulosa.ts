// nearparabolic.js, Chapter 35, Near-parabolic Motion.
/**
...
export class Elements {
   ...
   *
   * True anomaly nu returned in radians. Distance r returned in AU.
  ...
  anomalyDistance (jde) {
    ...
    let nu = 2 * Math.atan(s) // line 66
    const r = this.pDis * (1 + this.ecc) / (1 + this.ecc * Math.cos(nu)) // line 68
    if (nu < 0) { // line 70
      nu += 2 * Math.PI
    }
    return {
