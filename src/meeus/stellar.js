// stellar.js, Chapter 56, Stellar Magnitudes.
/**
 ...
 *
 * Argument m is apparent magnitude, pi is annual parallax in arc seconds.
 */
export function absoluteByParallax (m, pi) { // (m, pi float64)  float64
