// node.js, Chapter 39, Passages through the Nodes.
/**
...
export function el (nu, axis, ecc, timeP) { // (nu, axis, ecc, timeP float64)  (jde, r float64)
...
export function pa (nu, q, timeP) { // (nu, q, timeP float64)  (jde, r float64)
