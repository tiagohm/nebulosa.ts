// conjunction.js, Chapter 18: Planetary Conjunctions.
/**
 ...
 *    {Number} deltad - is the amount that object 2 was "above" object 1 at the time of conjunction.
 */
...
const conj = function (t1, t5, dr, dd) { // (t1, t5 float64, dr, dd []float64)  (t, deltad float64, err error)
  let l5 = new interp.Len5(t1, t5, dr)
  const t = l5.zero(true)
  l5 = new interp.Len5(t1, t5, dd)
  const deltad = l5.interpolateXStrict(t)
  return [t, deltad]
}
