// illum.js, Chapter 41, Illuminated Fraction of the Disk and Magnitude of a Planet.
/**
 ...
 *
 * Argument r is planet's distance to Sun, delta its distance to Earth, and R
 * the distance from Sun to Earth.  All distances in AU.
 *
 * Result in radians.
 */
export function phaseAngle (r, delta, R) { // (r, delta, R float64)  float64
 ...
 * the distance from Sun to Earth.  All distances in AU.
 */
export function fraction (r, delta, R) { // (r, delta, R float64)  float64
  // (41.2) p. 283
  const s = r + delta
 ...
 * L0, R0 are longitude and radius for Earth, delta is distance from Earth to
 * the planet.  All distances in AU, angles in radians.
 *
 * The phase angle result is in radians.
 */
export function phaseAngle2 (L, B, R, L0, R0, delta) { // (L, B, R, L0, R0, delta float64)  float64
  // (41.3) p. 283
 ...
 * The phase angle result is in radians.
 */
export function phaseAngle3 (L, B, x, y, z, delta) { // (L, B, x, y, z, delta float64)  float64
  // (41.4) p. 283
 ...
 * Formula by G. Müller
 *
 * Argument r is the planet's distance from the Sun, delta the distance from Earth,
 * and i the phase angle in radians.
 */
export function mercury (r, delta, i) { // (r, delta, i float64)  float64
  const s = toDeg(i) - 50
 ...
 * and i the phase angle in radians.
 */
export function venus (r, delta, i) { // (r, delta, i float64)  float64
  const iDeg = toDeg(i)
  return -4 + 5 * Math.log10(r * delta) + (0.01322 + 0.0000004247 * iDeg * iDeg) * iDeg
}
 ...
 * and i the phase angle in radians.
 */
export function mars (r, delta, i) { // (r, delta, i float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, delta the distance from Earth.
 */
export function jupiter (r, delta) { // (r, delta float64)  float64
 ...
 * Saturn's ring.
 * deltaU (in radians) is the difference between the Saturnicentric longitudes
 * of the Sun and the Earth, measured in the plane of the ring.
 * You can use saturndisk.Disk() to obtain B and deltaU.
 */
export function saturn (r, delta, B, deltaU) { // (r, delta, B, deltaU float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, delta the distance from Earth.
 */
export function uranus (r, delta) { // (r, delta float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, delta the distance from Earth.
 */
export function neptune (r, delta) { // (r, delta float64)  float64
 ...
 * and i the phase angle in radians.
 */
export function mercury84 (r, delta, i) { // (r, delta, i float64)  float64
  return base.horner(toDeg(i), -0.42 + 5 * Math.log10(r * delta),
 ...
 * and i the phase angle in radians.
 */
export function venus84 (r, delta, i) { // (r, delta, i float64)  float64
  return base.horner(toDeg(i), -4.4 + 5 * Math.log10(r * delta),
 ...
 * and i the phase angle in radians.
 */
export function mars84 (r, delta, i) { // (r, delta, i float64)  float64
 ...
 * and i the phase angle in radians.
 */
export function jupiter84 (r, delta, i) { // (r, delta, i float64)  float64
 ...
 * of the Sun and the Earth, measured in the plane of the ring.
 */
export function saturn84 (r, delta, B, deltaU) { // (r, delta, B, deltaU float64)  float64
  const s = Math.sin(Math.abs(B))
 ...
 * Argument r is the planet's distance from the Sun, delta the distance from Earth.
 */
export function uranus84 (r, delta) { // (r, delta float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, delta the distance from Earth.
 */
export function neptune84 (r, delta) { // (r, delta float64)  float64
 ...
 * Argument r is the planet's distance from the Sun, delta the distance from Earth.
 */
export function pluto84 (r, delta) { // (r, delta float64)  float64
