// circle.js, Chapter 20, Smallest Circle containing three Celestial Bodies.
/**
 ...
 * or longitude and latitude.  Result delta is the diameter of the circle, typeI
 * is true if solution is of type I.
 *
 * @param {Coord} c1 - ra, dec point 1
 * @param {Coord} c2 - ra, dec point 2
 * @param {Coord} c3 - ra, dec point 3
 * @returns {Array} [delta, typeI]
 *  {Number} delta - diameter of the circle
