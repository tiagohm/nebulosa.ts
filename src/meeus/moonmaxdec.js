// moonmaxdec.js, Chapter 52, Maximum Declinations of the Moon
/**
 ...
 */
export function north (y) { // (y float64)  (jde, delta float64)
  return max(y, nc)
}
 ...
 * of the Moon at that time.
 */
export function south (y) { // (y float64)  (jde, delta float64)
  return max(y, sc)
}
 ...
 * @private
 */
function max (y, c) { // (y float64, c *mc)  (jde, delta float64)
  ...
  const delta = 23.6961 * p - 0.013004 * p * T +
    c.dc[0] * Math.sin(f) +
    c.dc[1] * Math.cos(2 * f) +
