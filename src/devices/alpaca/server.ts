...
import type { CoverManager } from '../indi/manager/cover'
import type { DeviceHandler, DeviceManager } from '../indi/manager/device'
import type { DomeManager } from '../indi/manager/dome'
import type { FlatPanelManager } from '../indi/manager/flatpanel'
import type { FocuserManager } from '../indi/manager/focuser'
import type { GuideOutputManager } from '../indi/manager/guideoutput'
import type { MountManager } from '../indi/manager/mount'
import type { RotatorManager } from '../indi/manager/rotator'
import type { SafetyMonitorManager } from '../indi/manager/safetymonitor'
import type { WeatherManager } from '../indi/manager/weather'
import type { WheelManager } from '../indi/manager/wheel'
