...
test('eraGst06', () => {
	const rnpb = Matrix.square(3, [0.9999989440476103608, -0.1332881761240011518e-2, -0.5790767434730085097e-3, 0.1332858254308954453e-2, 0.9999991109044505944, -0.4097782710401555759e-4, 0.579130847216815332e-3, 0.4020595661593994396e-4, 0.9999998314954572365])
...
test('eraFw2m', () => {
	...
	expect(m.get(0, 0)).toBeCloseTo(0.9999995505176007047, 12)
	expect(m.get(0, 1)).toBeCloseTo(0.8695404617348192957e-3, 12)
	expect(m.get(0, 2)).toBeCloseTo(0.3779735201865582571e-3, 12)
	expect(m.get(1, 0)).toBeCloseTo(-0.8695404723772016038e-3, 12)
	expect(m.get(1, 1)).toBeCloseTo(0.9999996219496027161, 12)
	expect(m.get(1, 2)).toBeCloseTo(-0.1361752496887100026e-6, 12)
	expect(m.get(2, 0)).toBeCloseTo(-0.377973495703408279e-3, 12)
	expect(m.get(2, 1)).toBeCloseTo(-0.1924880848087615651e-6, 12)
	expect(m.get(2, 2)).toBeCloseTo(0.9999999285679971958, 12)
})
...
test('eraPnm06a', () => {
	...
	expect(m.get(0, 0)).toBeCloseTo(0.9999995832794205484, 12)
	expect(m.get(0, 1)).toBeCloseTo(0.8372382772630962111e-3, 14)
	expect(m.get(0, 2)).toBeCloseTo(0.3639684771140623099e-3, 14)
	expect(m.get(1, 0)).toBeCloseTo(-0.8372533744743683605e-3, 14)
	expect(m.get(1, 1)).toBeCloseTo(0.9999996486492861646, 12)
	expect(m.get(1, 2)).toBeCloseTo(0.4132905944611019498e-4, 14)
	expect(m.get(2, 0)).toBeCloseTo(-0.3639337469629464969e-3, 14)
	expect(m.get(2, 1)).toBeCloseTo(-0.4163377605910663999e-4, 14)
	expect(m.get(2, 2)).toBeCloseTo(0.9999999329094260057, 12)
})

test('eraPmat06', () => {
	const m = erfa.eraPmat06(2400000.5, 50123.9999)
	expect(m.get(0, 0)).toBeCloseTo(0.9999995505176007047, 12)
	expect(m.get(0, 1)).toBeCloseTo(0.8695404617348208406e-3, 14)
	expect(m.get(0, 2)).toBeCloseTo(0.3779735201865589104e-3, 14)
	expect(m.get(1, 0)).toBeCloseTo(-0.8695404723772031414e-3, 14)
	expect(m.get(1, 1)).toBeCloseTo(0.9999996219496027161, 12)
	expect(m.get(1, 2)).toBeCloseTo(-0.1361752497080270143e-6, 14)
	expect(m.get(2, 0)).toBeCloseTo(-0.377973495703408949e-3, 14)
	expect(m.get(2, 1)).toBeCloseTo(-0.1924880847894457113e-6, 14)
	expect(m.get(2, 2)).toBeCloseTo(0.9999999285679971958, 12)
})
...
test('eraPom00', () => {
	...
	expect(m.get(0, 0)).toBeCloseTo(0.9999999999999674721, 12)
	expect(m.get(0, 1)).toBeCloseTo(-0.1367174580728846989e-10, 12)
	expect(m.get(0, 2)).toBeCloseTo(0.2550602379999972345e-6, 12)
	expect(m.get(1, 0)).toBeCloseTo(0.1414624947957029801e-10, 12)
	expect(m.get(1, 1)).toBeCloseTo(0.9999999999982695317, 12)
	expect(m.get(1, 2)).toBeCloseTo(-0.1860359246998866389e-5, 12)
	expect(m.get(2, 0)).toBeCloseTo(-0.2550602379741215021e-6, 12)
	expect(m.get(2, 1)).toBeCloseTo(0.1860359247002414021e-5, 12)
	expect(m.get(2, 2)).toBeCloseTo(0.9999999999982370039, 12)
})

test('eraC2teqx', () => {
	const rbpn = Matrix.square(3, [0.9999989440476103608, -0.1332881761240011518e-2, -0.5790767434730085097e-3, 0.1332858254308954453e-2, 0.9999991109044505944, -0.4097782710401555759e-4, 0.579130847216815332e-3, 0.4020595661593994396e-4, 0.9999998314954572365])
	const rpom = Matrix.square(3, [0.9999999999999674705, -0.1367174580728847031e-10, 0.2550602379999972723e-6, 0.1414624947957029721e-10, 0.9999999999982694954, -0.1860359246998866338e-5, -0.2550602379741215275e-6, 0.1860359247002413923e-5, 0.9999999999982369658])

	const m = erfa.eraC2teqx(rbpn, 1.754166138040730516, rpom)
	expect(m.get(0, 0)).toBeCloseTo(-0.181033212852868573, 12)
	expect(m.get(0, 1)).toBeCloseTo(0.9834769806897685071, 12)
	expect(m.get(0, 2)).toBeCloseTo(0.6555535639982634449e-4, 12)
	expect(m.get(1, 0)).toBeCloseTo(-0.9834768134095211257, 12)
	expect(m.get(1, 1)).toBeCloseTo(-0.18103322038710238, 12)
	expect(m.get(1, 2)).toBeCloseTo(0.5749801116126438962e-3, 12)
	expect(m.get(2, 0)).toBeCloseTo(0.5773474014081539467e-3, 12)
	expect(m.get(2, 1)).toBeCloseTo(0.3961832391768640871e-4, 12)
	expect(m.get(2, 2)).toBeCloseTo(0.9999998325501691969, 12)
})
...
test('eraBp06', () => {
	...
	expect(rb.get(0, 0)).toBeCloseTo(0.9999999999999942497, 12)
	expect(rb.get(0, 1)).toBeCloseTo(-0.7078368960971557145e-7, 14)
	expect(rb.get(0, 2)).toBeCloseTo(0.8056213977613185606e-7, 14)
	expect(rb.get(1, 0)).toBeCloseTo(0.7078368694637674333e-7, 14)
	expect(rb.get(1, 1)).toBeCloseTo(0.9999999999999969484, 12)
	expect(rb.get(1, 2)).toBeCloseTo(0.3305943742989134124e-7, 14)
	expect(rb.get(2, 0)).toBeCloseTo(-0.8056214211620056792e-7, 14)
	expect(rb.get(2, 1)).toBeCloseTo(-0.330594317274058695e-7, 14)
	expect(rb.get(2, 2)).toBeCloseTo(0.9999999999999962084, 12)

	expect(rp.get(0, 0)).toBeCloseTo(0.9999995504864960278, 12)
	expect(rp.get(0, 1)).toBeCloseTo(0.8696112578855404832e-3, 14)
	expect(rp.get(0, 2)).toBeCloseTo(0.3778929293341390127e-3, 14)
	expect(rp.get(1, 0)).toBeCloseTo(-0.8696112560510186244e-3, 14)
	expect(rp.get(1, 1)).toBeCloseTo(0.999999621888045882, 12)
	expect(rp.get(1, 2)).toBeCloseTo(-0.1691646168941896285e-6, 14)
	expect(rp.get(2, 0)).toBeCloseTo(-0.3778929335557603418e-3, 14)
	expect(rp.get(2, 1)).toBeCloseTo(-0.1594554040786495076e-6, 14)
	expect(rp.get(2, 2)).toBeCloseTo(0.9999999285984501222, 12)

	expect(rbp.get(0, 0)).toBeCloseTo(0.9999995505176007047, 12)
	expect(rbp.get(0, 1)).toBeCloseTo(0.8695404617348208406e-3, 14)
	expect(rbp.get(0, 2)).toBeCloseTo(0.3779735201865589104e-3, 14)
	expect(rbp.get(1, 0)).toBeCloseTo(-0.8695404723772031414e-3, 14)
	expect(rbp.get(1, 1)).toBeCloseTo(0.9999996219496027161, 12)
	expect(rbp.get(1, 2)).toBeCloseTo(-0.1361752497080270143e-6, 14)
	expect(rbp.get(2, 0)).toBeCloseTo(-0.377973495703408949e-3, 14)
	expect(rbp.get(2, 1)).toBeCloseTo(-0.1924880847894457113e-6, 14)
	expect(rbp.get(2, 2)).toBeCloseTo(0.9999999285679971958, 12)
})
...
test('eraC2tcio', () => {
	const rc2i = Matrix.square(3, [0.9999998323037164738, 0.5581526271714303683e-9, -0.5791308477073443903e-3, -0.2384266227524722273e-7, 0.9999999991917404296, -0.4020594955030704125e-4, 0.579130847216815332e-3, 0.4020595661593994396e-4, 0.9999998314954572365])
	const rpom = Matrix.square(3, [0.9999999999999674705, -0.1367174580728847031e-10, 0.2550602379999972723e-6, 0.1414624947957029721e-10, 0.9999999999982694954, -0.1860359246998866338e-5, -0.2550602379741215275e-6, 0.1860359247002413923e-5, 0.9999999999982369658])
	const r = erfa.eraC2tcio(rc2i, 1.75283325530307, rpom)

	expect(r.get(0, 0)).toBeCloseTo(-0.1810332128307110439, 12)
	expect(r.get(0, 1)).toBeCloseTo(0.9834769806938470149, 12)
	expect(r.get(0, 2)).toBeCloseTo(0.6555535638685466874e-4, 12)
	expect(r.get(1, 0)).toBeCloseTo(-0.9834768134135996657, 12)
	expect(r.get(1, 1)).toBeCloseTo(-0.1810332203649448367, 12)
	expect(r.get(1, 2)).toBeCloseTo(0.5749801116141106528e-3, 12)
	expect(r.get(2, 0)).toBeCloseTo(0.5773474014081407076e-3, 12)
	expect(r.get(2, 1)).toBeCloseTo(0.3961832391772658944e-4, 12)
	expect(r.get(2, 2)).toBeCloseTo(0.9999998325501691969, 12)
})

test('eraC2ixys', () => {
	const r = erfa.eraC2ixys(0.5791308486706011e-3, 0.4020579816732961219e-4, -0.1220040848472271978e-7)

	expect(r.get(0, 0)).toBeCloseTo(0.9999998323037157138, 12)
	expect(r.get(0, 1)).toBeCloseTo(0.5581984869168499149e-9, 12)
	expect(r.get(0, 2)).toBeCloseTo(-0.579130849161128218e-3, 12)
	expect(r.get(1, 0)).toBeCloseTo(-0.2384261642670440317e-7, 12)
	expect(r.get(1, 1)).toBeCloseTo(0.9999999991917468964, 12)
	expect(r.get(1, 2)).toBeCloseTo(-0.4020579110169668931e-4, 12)
	expect(r.get(2, 0)).toBeCloseTo(0.5791308486706011e-3, 12)
	expect(r.get(2, 1)).toBeCloseTo(0.4020579816732961219e-4, 12)
	expect(r.get(2, 2)).toBeCloseTo(0.999999831495462759, 12)
})

test('eraC2i06a', () => {
	const r = erfa.eraC2i06a(2400000.5, 53736.0)

	expect(r.get(0, 0)).toBeCloseTo(0.9999998323037159379, 12)
	expect(r.get(0, 1)).toBeCloseTo(0.5581121329587613787e-9, 12)
	expect(r.get(0, 2)).toBeCloseTo(-0.5791308487740529749e-3, 12)
	expect(r.get(1, 0)).toBeCloseTo(-0.2384253169452306581e-7, 12)
	expect(r.get(1, 1)).toBeCloseTo(0.9999999991917467827, 12)
	expect(r.get(1, 2)).toBeCloseTo(-0.4020579392895682558e-4, 12)
	expect(r.get(2, 0)).toBeCloseTo(0.5791308482835292617e-3, 12)
	expect(r.get(2, 1)).toBeCloseTo(0.402058009945402031e-4, 12)
	expect(r.get(2, 2)).toBeCloseTo(0.9999998314954628695, 12)
})

test('eraC2t06a', () => {
	const r = erfa.eraC2t06a(2400000.5, 53736.0, 2400000.5, 53736.0, 2.55060238e-7, 1.860359247e-6)

	expect(r.get(0, 0)).toBeCloseTo(-0.1810332128305897282, 12)
	expect(r.get(0, 1)).toBeCloseTo(0.9834769806938592296, 12)
	expect(r.get(0, 2)).toBeCloseTo(0.6555550962998436505e-4, 12)
	expect(r.get(1, 0)).toBeCloseTo(-0.9834768134136214897, 12)
	expect(r.get(1, 1)).toBeCloseTo(-0.1810332203649130832, 12)
	expect(r.get(1, 2)).toBeCloseTo(0.574980084490559411e-3, 12)
	expect(r.get(2, 0)).toBeCloseTo(0.5773474024748545878e-3, 12)
	expect(r.get(2, 1)).toBeCloseTo(0.3961816829632690581e-4, 12)
	expect(r.get(2, 2)).toBeCloseTo(0.9999998325501747785, 12)
})
...
test('eraApci13', () => {
	...
	expect(astrom.bpn.get(0, 0)).toBeCloseTo(0.999999206037676171, 12)
	expect(astrom.bpn.get(1, 0)).toBeCloseTo(0.4124244860106037157e-7, 12)
	expect(astrom.bpn.get(2, 0)).toBeCloseTo(0.126012857105170967e-2, 12)
	expect(astrom.bpn.get(0, 1)).toBeCloseTo(-0.128229198722213069e-7, 12)
	expect(astrom.bpn.get(1, 1)).toBeCloseTo(0.9999999997456835325, 12)
	expect(astrom.bpn.get(2, 1)).toBeCloseTo(-0.2255288829420524935e-4, 12)
	expect(astrom.bpn.get(0, 2)).toBeCloseTo(-0.1260128571661374559e-2, 12)
	expect(astrom.bpn.get(1, 2)).toBeCloseTo(0.2255285422953395494e-4, 12)
	expect(astrom.bpn.get(2, 2)).toBeCloseTo(0.9999992057833604343, 12)
...
test('eraApci', () => {
	...
	expect(astrom.bpn.get(0, 0)).toBeCloseTo(0.9999991390295159156, 12)
	expect(astrom.bpn.get(1, 0)).toBeCloseTo(0.4978650072505016932e-7, 12)
	expect(astrom.bpn.get(2, 0)).toBeCloseTo(0.13122272e-2, 12)
	expect(astrom.bpn.get(0, 1)).toBeCloseTo(-0.113633665377160963e-7, 12)
	expect(astrom.bpn.get(1, 1)).toBeCloseTo(0.9999999995713154868, 12)
	expect(astrom.bpn.get(2, 1)).toBeCloseTo(-0.292808623e-4, 12)
	expect(astrom.bpn.get(0, 2)).toBeCloseTo(-0.1312227200895260194e-2, 12)
	expect(astrom.bpn.get(1, 2)).toBeCloseTo(0.292808221787231568e-4, 12)
	expect(astrom.bpn.get(2, 2)).toBeCloseTo(0.9999991386008323373, 12)
})
...
test('eraApcg', () => {
	...
	expect(astrom.v[2]).toBeCloseTo(0.3517555136380563427e-4, 16)
	expect(astrom.bm1).toBeCloseTo(0.9999999951686012981, 12)
	expect(astrom.bpn.get(0, 0)).toBeCloseTo(1, 12)
	expect(astrom.bpn.get(1, 0)).toBeCloseTo(0, 12)
	expect(astrom.bpn.get(2, 0)).toBeCloseTo(0, 12)
	expect(astrom.bpn.get(0, 1)).toBeCloseTo(0, 12)
	expect(astrom.bpn.get(1, 1)).toBeCloseTo(1, 12)
	expect(astrom.bpn.get(2, 1)).toBeCloseTo(0, 12)
	expect(astrom.bpn.get(0, 2)).toBeCloseTo(0, 12)
	expect(astrom.bpn.get(1, 2)).toBeCloseTo(0, 12)
	expect(astrom.bpn.get(2, 2)).toBeCloseTo(1, 12)
})
...
test('eraAtciq', () => {
	...
	const [ra, dec] = erfa.eraC2s(p[0], p[1], p[2])
...
test('eraApco13', () => {
	...
	expect(astrom.bpn.get(0, 0)).toBeCloseTo(0.9999991390295147999, 12)
	expect(astrom.bpn.get(1, 0)).toBeCloseTo(0.4978650075315529277e-7, 12)
	expect(astrom.bpn.get(2, 0)).toBeCloseTo(0.001312227200850293372, 12)
	expect(astrom.bpn.get(0, 1)).toBeCloseTo(-0.1136336652812486604e-7, 12)
	expect(astrom.bpn.get(1, 1)).toBeCloseTo(0.9999999995713154865, 12)
	expect(astrom.bpn.get(2, 1)).toBeCloseTo(-0.2928086230975367296e-4, 12)
	expect(astrom.bpn.get(0, 2)).toBeCloseTo(-0.001312227201745553566, 12)
	expect(astrom.bpn.get(1, 2)).toBeCloseTo(0.2928082218847679162e-4, 12)
	expect(astrom.bpn.get(2, 2)).toBeCloseTo(0.9999991386008312212, 12)
