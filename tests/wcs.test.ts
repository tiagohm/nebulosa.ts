...
test('azp', () => {
	const header = { CTYPE1: 'RA---AZP', CRPIX1: -2.541100848779e2, CDELT1: -6.666666666667e-2, CRVAL1: 0, CTYPE2: 'DEC--AZP', CRPIX2: -1.134948542534e1, CDELT2: 6.666666666667e-2, CRVAL2: -9.0e1, LONPOLE: 1.8e2, LATPOLE: -9.0e1, PV2_1: 2, PV2_2: 3.0e1, EQUINOX: 2.0e3 }
	project(header)
})
...
test('szp', () => {
	const header = { CTYPE1: 'RA---SZP', CRPIX1: -2.478656972779e2, CDELT1: -6.666666666667e-2, CRVAL1: 0, CTYPE2: 'DEC--SZP', CRPIX2: -2.262051956373e1, CDELT2: 6.666666666667e-2, CRVAL2: -9.0e1, LONPOLE: 1.8e2, LATPOLE: -9.0e1, PV2_1: 2, PV2_2: 1.8e2, PV2_3: 6.0e1, EQUINOX: 2.0e3 }
	project(header)
})
