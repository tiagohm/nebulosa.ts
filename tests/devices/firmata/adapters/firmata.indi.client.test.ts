...
import { FirmataIndiClient } from '../../../../src/devices/firmata/adapters/firmata.indi.client'
import { FirmataClient, type FirmataClientHandler, type Transport } from '../../../../src/devices/firmata/firmata'
import { ESP8266 } from '../../../../src/devices/firmata/firmata.board'
import type { Accelerometer, Altimeter, Ammeter, Barometer, Gyroscope, Hygrometer, ListenablePeripheral, Luxmeter, Magnetometer, Peripheral, PeripheralListener, RealTimeClock, Thermometer } from '../../../../src/devices/firmata/firmata.peripheral'
import { LM35 } from '../../../../src/devices/firmata/sensors/firmata.thermometer'
import type { IndiClientHandler } from '../../../../src/devices/indi/indi.client'
import type { DefNumberVector, DelProperty, SetNumberVector, SetSwitchVector } from '../../../../src/devices/indi/indi.types'
