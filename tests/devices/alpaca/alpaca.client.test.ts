...
import { AlpacaClient, type AlpacaClientHandler, makeFitsFromImageBytes } from '../../../src/devices/alpaca/alpaca.client'
import { makeImageBytesFromFits } from '../../../src/devices/alpaca/alpaca.server'
import { CLIENT, type Client, DEFAULT_CAMERA, DEFAULT_MOUNT, type Device, type DeviceType } from '../../../src/devices/indi/indi.device'
import { CameraManager, CoverManager, type DeviceProvider, FlatPanelManager, FocuserManager, GuideOutputManager, MountManager, RotatorManager, ThermometerManager, WheelManager } from '../../../src/devices/indi/indi.manager'
import type { PropertyState } from '../../../src/devices/indi/indi.types'
import { readImageFromBuffer } from '../../../src/imaging/model/image'
import { debayer } from '../../../src/imaging/processing/image.transformation'
