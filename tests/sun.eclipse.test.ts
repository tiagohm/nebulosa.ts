...
test('computeSolarEclipseMapGeometry anchors NASA total central endpoints', () => {
	...
	expectGeoPointClose(lines.umbraNorth[0][0], -2.715434968822, -0.118805499351, 2460409.195637829)
	expectGeoPointClose(lines.umbraNorth[0][8], -1.944363379336, 0.32849714517, 2460409.2458870145)
	expectGeoPointClose(lines.umbraSouth[0][0], -2.668875495787, -0.132716095986, 2460409.195258044)
