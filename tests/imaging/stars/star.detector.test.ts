...
import { detectStars, excludeStarsFitWithinRegion, measureStarPhotometry, mergeVeryCloseStars, StarList } from '../../../src/imaging/stars/star.detector'
import { type PlotStarOptions, plotStar } from '../../../src/imaging/stars/star.generator'
import { type AstronomicalImageNoiseConfig, type AstronomicalImageStar, DEFAULT_ASTRONOMICAL_IMAGE_NOISE_CONFIG, generateNoiseImage, generateStarImage } from '../../../src/imaging/synthetic/image.generator'
