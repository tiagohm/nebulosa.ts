...
test('constellation', () => {
	...
	expect(constellation(hour(22), deg(86.16), B1875)).toBe('CEP')
	expect(constellation(hour(22), deg(86.1666), B1875)).toBe('CEP')
	expect(constellation(hour(22), deg(86.16668), B1875)).toBe('UMI')
	expect(constellation(hour(22), deg(86.1668), B1875)).toBe('UMI')
