...
describe.skip('identify', () => {
	test('ceres', async () => {
		const date = temporalFromDate(2023, 8, 21, 0, 0, 0)
		const response = await identify(date, deg(-45.5), deg(-22.5), kilometer(1.81754), parseAngle('13h 21 16.50')!, parseAngle('-01 57 06.5')!)
